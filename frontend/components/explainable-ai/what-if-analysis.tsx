      ...
      <div className="p-4 bg-muted rounded-md">
        ...
        <div className="relative h-8 bg-muted-foreground/20 rounded-full overflow-hidden">
          ...
          <div
            ...
            style={{ width: `${newProbability * 100}%` }}
          ></div>
        ...
        <div className="mt-4 text-sm text-muted-foreground">
          {newProbability < currentProbability ? (
            <p>
              These changes would <span className="text-success font-medium">reduce</span> the
              probability of defects by {((currentProbability - newProbability) * 100).toFixed(1)}%.
            </p>
          ) : newProbability > currentProbability ? (
            <p>
              These changes would <span className="text-destructive font-medium">increase</span> the
              probability of defects by {((newProbability - currentProbability) * 100).toFixed(1)}%.
            </p>
          ) : (
