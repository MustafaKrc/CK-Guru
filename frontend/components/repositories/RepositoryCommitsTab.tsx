        ...
        <>
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>A preview of the {ITEMS_PER_PAGE_PREVIEW} most recent commits. Click a hash to see the full page.</CardDescription>
                </CardHeader>
                <CardContent>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {isLoading ? (
                                    ...
                                    <TableRow><TableCell colSpan={5} className="text-center py-8 text-muted-foreground">No commits found.</TableCell></TableRow>
                                ) : (
                                    commits.map(commit => {
                                        ...
                                        <TableRow key={commit.commit_hash}>
                                            ...
                                            <TableCell className="text-right space-x-2">
                                                <Button variant="ghost" size="sm" onClick={() => setSelectedCommitDialog(commit.commit_hash)}>
