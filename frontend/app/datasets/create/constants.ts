...
const METRIC_DEFINITIONS: Record<string, string> = {
  ...
  cboModified: "CBO Modified: CBO, but only counting classes from the project (not from external libraries).",
  ...
  comparisonsQty: "Comparisons Quantity: The number of comparison operators (e.g., >, <, ==) in a method.",
  tryCatchQty: "Try-Catch Quantity: The number of try-catch blocks in a method.",
  parenthesizedExpsQty: "Parenthesized Expressions Quantity: The number of parenthesized expressions.",
  ...
  maxNestedBlocksQty: "Max Nested Blocks Quantity: The maximum nesting level of blocks (e.g., if, for, while).",
  ...
  uniqueWordsQty: "Unique Words Quantity: The number of unique words in the source code of the class.",
  modifiers: "Modifiers: A bitmask representing class/method/field modifiers (e.g., public, static, final).",
  ...
  entropy: "Entropy of modified files: Distribution of changes across files. Higher entropy means changes are more spread out.",
