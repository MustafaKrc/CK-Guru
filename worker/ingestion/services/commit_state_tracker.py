...
class CommitFile:
    ...
    def __init__(self, name: str, loc: int, authors: List[str], lastchanged: int):
        ...
        self.authors: List[str] = (
            authors  # List of unique authors who touched this file
        )
...
class FileStateTracker:
    ...
    def update_file(
        self, parsed_line: ParsedNumstatLine, author: str, timestamp: int
    ) -> FileUpdateResult:
        """
        ...
        previous_nuc = 0
        time_diff_days = 0.0
        authors_involved_before: Set[str] = (
            set()
        )  # Authors who touched it before THIS commit
        ...
        return FileUpdateResult(
            previous_loc, previous_nuc, time_diff_days, authors_involved_before
        )
...
class DeveloperExperienceTracker:
    ...
    def update_experience(self, author: str, subsystem: str) -> DevExperienceMetrics:
        """
        ...
        if author in self._dev_states:
            ...
            sexp = author_exp_map.get(
                subsystem, 0
            )  # Subsystem exp = count for this subsystem
        ...
        self._dev_states[author][subsystem] = (
            self._dev_states[author].get(subsystem, 0) + 1
        )
