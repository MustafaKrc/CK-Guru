...
from sqlalchemy import (ForeignKey, Text, JSON, DateTime, Enum, Index, String, Integer)
...
class InferenceJob(Base):
    ...
    celery_task_id: Mapped[str | None] = mapped_column(String, nullable=True, index=True, unique=False) # Can be non-unique if retried
    ...
    def __repr__(self):
        commit = self.input_reference.get('commit_hash', 'N/A')[:7] if isinstance(self.input_reference, dict) else 'N/A'
