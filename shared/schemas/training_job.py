...
class TrainingConfig(BaseModel):
    ...
    eval_test_split_size: Optional[float] = Field(0.2, ge=0, lt=1, description="Fraction for test split during evaluation.")
...
class TrainingJobRead(TrainingJobBase):
    ...
    status_message: Optional[str] = None
    ml_model_id: Optional[int] = None
    ml_model: Optional[MLModelRead] = Field(None, description="Details of the model created by this job.") # Nested model
    started_at: Optional[datetime] = None
    completed_at: Optional[datetime] = None
    created_at: datetime
    updated_at: datetime
