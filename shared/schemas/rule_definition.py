...
class RuleParamDefinition(BaseModel):
    ...
    required: bool = Field(default=False, description="Indicates if the parameter is mandatory (validation handled by presence/default).")
...
class RuleDefinition(BaseModel):
    ...
    is_batch_safe: bool = Field(..., description="Indicates if the rule can operate safely on data batches independently.")
    is_implemented: bool = Field(..., description="Indicates if the rule implementation exists and is active in the worker.")
