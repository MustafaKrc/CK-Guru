...
def upgrade() -> None:
    ...
    op.create_table('cleaning_rule_definitions',
    ...
    op.create_index(op.f('ix_cleaning_rule_definitions_is_implemented'), 'cleaning_rule_definitions', ['is_implemented'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_cleaning_rule_definitions_is_implemented'), table_name='cleaning_rule_definitions')
