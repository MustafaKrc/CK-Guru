...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_hp_search_jobs_celery_task_id"),
        "hp_search_jobs",
        ["celery_task_id"],
        unique=True,
    )
    op.create_index(
        op.f("ix_hp_search_jobs_dataset_id"),
        "hp_search_jobs",
        ["dataset_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_hp_search_jobs_id"), "hp_search_jobs", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_hp_search_jobs_optuna_study_name"),
        "hp_search_jobs",
        ["optuna_study_name"],
        unique=True,
    )
    op.create_index(
        op.f("ix_hp_search_jobs_status"), "hp_search_jobs", ["status"], unique=False
    )
    op.create_table(
        "training_jobs",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column("status_message", sa.Text(), nullable=True),
        sa.Column(
            "config", sa.JSON(), nullable=False, comment="Training configuration used"
        ),
        sa.Column("dataset_id", sa.Integer(), nullable=False),
        sa.Column("started_at", sa.DateTime(timezone=True), nullable=True),
        sa.Column("completed_at", sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_index(
        op.f("ix_training_jobs_celery_task_id"),
        "training_jobs",
        ["celery_task_id"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["hp_search_job_id"], ["hp_search_jobs.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_ml_models_dataset_id"), "ml_models", ["dataset_id"], unique=False
    )
    op.create_index(
        op.f("ix_ml_models_hp_search_job_id"),
        "ml_models",
        ["hp_search_job_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_ml_models_training_job_id"),
        "ml_models",
        ["training_job_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_ml_models_version"), "ml_models", ["version"], unique=False
    )
    op.create_table(
        "inference_jobs",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_inference_jobs_id"), "inference_jobs", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_inference_jobs_ml_model_id"),
        "inference_jobs",
        ["ml_model_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_inference_jobs_status"), "inference_jobs", ["status"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_hp_search_jobs_optuna_study_name"), table_name="hp_search_jobs"
    )
