...
Revision ID: 622696c82b09
Revises: 
Create Date: 2025-04-02 22:15:14.276255
...
def upgrade() -> None:
    ...
    sa.Column('github_issue_ids', sa.JSON(), nullable=True),
    sa.Column('github_earliest_issue_open_timestamp', sa.BigInteger(), nullable=True),
    sa.ForeignKeyConstraint(['repository_id'], ['repositories.id'], ),
    sa.PrimaryKeyConstraint('id'),
