...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_repositories_git_url"), "repositories", ["git_url"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_ck_metrics_commit_hash"), "ck_metrics", ["commit_hash"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_ck_metrics_repository_id"),
        "ck_metrics",
        ["repository_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "repository_id", "commit_hash", name="uq_commit_guru_metric"
        ),
    )
    op.create_index(
        op.f("ix_commit_guru_metrics_commit_hash"),
        "commit_guru_metrics",
        ["commit_hash"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commit_guru_metrics_id"), "commit_guru_metrics", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_commit_guru_metrics_is_buggy"),
        "commit_guru_metrics",
        ["is_buggy"],
        unique=False,
    )
    op.create_index(
        op.f("ix_commit_guru_metrics_repository_id"),
        "commit_guru_metrics",
        ["repository_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "state", sa.String(length=20), server_default="unknown", nullable=False
        ),
        ...
        sa.UniqueConstraint(
            "repository_id", "issue_number", name="uq_repo_issue_number"
        ),
    )
    op.create_index(op.f("ix_github_issues_id"), "github_issues", ["id"], unique=False)
    op.create_index(
        op.f("ix_github_issues_issue_number"),
        "github_issues",
        ["issue_number"],
        unique=False,
    )
    op.create_index(
        op.f("ix_github_issues_repository_id"),
        "github_issues",
        ["repository_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["commit_guru_metric_id"], ["commit_guru_metrics.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["github_issue_id"], ["github_issues.id"], ondelete="CASCADE"
        ),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_commit_guru_metrics_repository_id"), table_name="commit_guru_metrics"
    )
    op.drop_index(
        op.f("ix_commit_guru_metrics_is_buggy"), table_name="commit_guru_metrics"
    )
    op.drop_index(op.f("ix_commit_guru_metrics_id"), table_name="commit_guru_metrics")
    op.drop_index(
        op.f("ix_commit_guru_metrics_commit_hash"), table_name="commit_guru_metrics"
    )
