...
def upgrade() -> None:
    ...
    op.drop_constraint(
        "bot_patterns_repository_id_fkey", "bot_patterns", type_="foreignkey"
    )
    op.create_foreign_key(
        "bot_patterns_repository_id_fkey",
        "bot_patterns",
        "repositories",
        ["repository_id"],
        ["id"],
    ...
    op.drop_constraint(
        "github_issues_repository_id_fkey", "github_issues", type_="foreignkey"
    )
    op.create_foreign_key(
        "github_issues_repository_id_fkey",
        "github_issues",
        "repositories",
        ["repository_id"],
        ["id"],
    ...
    op.drop_constraint(
        "ck_metrics_repository_id_fkey", "ck_metrics", type_="foreignkey"
    )
    op.create_foreign_key(
        "ck_metrics_repository_id_fkey",
        "ck_metrics",
        "repositories",
        ["repository_id"],
        ["id"],
    ...
    op.drop_constraint(
        "commit_guru_metrics_repository_id_fkey",
        "commit_guru_metrics",
        type_="foreignkey",
    )
    op.create_foreign_key(
    ...
    op.drop_constraint(
        "hp_search_jobs_dataset_id_fkey", "hp_search_jobs", type_="foreignkey"
    )
    op.create_foreign_key(
        "hp_search_jobs_dataset_id_fkey",
        "hp_search_jobs",
        "datasets",
        ["dataset_id"],
        ["id"],
    ...
    op.drop_constraint(
        "inference_jobs_ml_model_id_fkey", "inference_jobs", type_="foreignkey"
    )
    op.create_foreign_key(
        "inference_jobs_ml_model_id_fkey",
        "inference_jobs",
        "ml_models",
        ["ml_model_id"],
        ["id"],
    ...
    op.drop_constraint(
        "xai_results_inference_job_id_fkey", "xai_results", type_="foreignkey"
    )
    op.create_foreign_key(
        "xai_results_inference_job_id_fkey",
        "xai_results",
        "inference_jobs",
        ["inference_job_id"],
        ["id"],
    ...
    op.drop_constraint(
        "commit_github_issue_association_commit_guru_metric_id_fkey",
    ...
    op.drop_constraint(
        "commit_github_issue_association_github_issue_id_fkey",
        "commit_github_issue_association",
        type_="foreignkey",
    )
    op.create_foreign_key(
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        ...
        ["github_issue_id"],
        ["id"],
        ondelete="CASCADE",  # Original was CASCADE
    )
    op.drop_constraint(
        "commit_github_issue_association_commit_guru_metric_id_fkey",
        "commit_github_issue_association",
    ...
    op.create_foreign_key(
        ...
        ["dataset_id"],
        ["id"],
        ondelete="SET NULL",  # Original was SET NULL for this one
    )
    ...
    op.create_foreign_key(
        ...
        "repositories",
        ["repository_id"],
        ["id"],  # Default ON DELETE (NO ACTION / RESTRICT)
    )
    ...
    op.create_foreign_key(
        ...
        ["repository_id"],
        ["id"],
        ondelete="CASCADE",  # Original was CASCADE for this one
    )
