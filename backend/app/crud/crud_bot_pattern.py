    ...
    *,
    ...
    if repository_id is not None:
        if include_global:
            ...
            filters.append((BotPattern.repository_id == repository_id) | (BotPattern.repository_id.is_(None)))
        else:
    ...
    stmt = stmt.order_by(BotPattern.repository_id.nullslast(), BotPattern.id).offset(skip).limit(limit) # Show global last
